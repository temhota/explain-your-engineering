...
export const observationSchema = z.object({
  kind: z.enum(["strength", "gap", "check"]),
...
export const feedbackSchema = z.object({
  communication: z.array(observationSchema).max(3),
  technical: z.array(observationSchema).max(3),
});
...
export const sessionSchema = z.object({
  ...
  demo: z.boolean(),
  stage: stageSchema,
  answer1: z.string().max(12000),
  answer2: z.string().max(12000),
